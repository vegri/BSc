...
den entsprechenden Winkeln $\alpha=109{,}5\degree$ und $\beta=70{,}5\degree$ passt (siehe
Abb. \ref{winkel}c)).
...
definierten Spots mit wenig Hintergrundleuten - ist die Probe trotzdem geeignet, um als Substrat für
Gold zu dienen und dessen Wachstum zu untersuchen.
