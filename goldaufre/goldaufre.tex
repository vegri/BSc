...
den entsprechenden Winkeln $\alpha\approx109{,}5\degree$ und $\beta\approx70{,}5\degree$ passt
...
verursacht.
Da die Oberfläche trotz der Abweichung in den Winkeln eine ausreichende Periodizität und nur eine geringe Oberflächenrauhigkeit aufweist - zu sehen an dem klar definierten Spots mit wenig
Hintergrundleuchten - ist die Probe trotzdem geeignet, um als Substrat für Gold zu dienen und
...
\end{figure}
\end{minipage}
Substrat gestreuten Elektronen wird allerdings geringer,
...
% Dabei beträgt die Höhendifferenz in beiden Bildern gleich bzw. weniger
...
durchaus als Substrat für Moleküle geeignet. Falls erforderlich, könnten eventuell durch Tempern
